    ...
    return function(root, result) {
        ...
        root.walkAtRules(function(atrule) {
            ...
            if (error = lexer.matchAtrulePrelude(atrule.name, atrule.params).error) {
                ...
                if (message === 'Mismatch') {
                    ...
                    endIndex = index + (error.mismatchLength || 1);
                } else {
                    message = messages.csstree(message);
                    endIndex = index + (atrule.params ? atrule.params.length : 0);
                }
        ...
        root.walkDecls((decl) => {
            ...
            try {
                ...
                const valueOffset = decl.prop.length + getRaw(decl, 'between').length;
                ...
                return utils.report({
                    ...
                    ruleName,
                    index: valueOffset,
                    endIndex: valueOffset + decl.value.length
                });
            }
