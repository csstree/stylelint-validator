const { tokenTypes: TYPE } = require('css-tree');
...
module.exports = function extendParser(syntaxConfig) {
    ...
    syntaxConfig.node.LessNamespace = require('./less/LessNamespace');
    ...
    syntaxConfig.node.SassNamespace = require('./sass/SassNamespace');
